...
VIDEO_NAME = '2025_05_23-07_30_11_PM' # camera#_YYYY_MM_DD-HH_MM_SS
SAVE_VIDEO = True
...
# Open the video file
video_path = f"../../../vids/{VIDEO_NAME}.mp4"
...
if SAVE_VIDEO:
    output_path = f'../../../vids/test/{VIDEO_NAME}.avi'
        ...
        if result.boxes and result.boxes.id is not None:
            ...
            for i, (box, track_id) in enumerate(zip(boxes, track_ids)):
                if hasattr(result, "keypoints") and result.keypoints is not None:
                    ...
                    timestamp_formatted = datetime.datetime.strptime(VIDEO_NAME, "%Y_%m_%d-%I_%M_%S_%p")
